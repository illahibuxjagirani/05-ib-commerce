...
async function Hero() {
  ...
  return (
    <section className='mx-auto max-2xl px-4 lg:max-w-7xl lg:px-8 h-[90%]'>
        <div className='flex flex-wrap justify-between'>
            ...
            <div className='flex w-full lg:w-2/3 '>
              <div className='relative left-12 top-2 z-10 -ml-12 overflow-hidden rounded-lg bg-gray-100 shadow-lg md:left-16 md:top-6 lg:ml-0'>
                <Image 
